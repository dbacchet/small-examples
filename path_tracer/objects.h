...
struct HitRecord {
    ...
    HitRecord() = default;
    HitRecord(float t_, const math::Vector3f &point_, const math::Vector3f &normal_, Material *mtl)
...
public:
    ...
    Sphere(const math::Vector3f &center, float radius, Material *material)
